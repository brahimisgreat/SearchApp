  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.sociallinks}>
        ...
        <div className={classes.sl}>
          <img src={twitter}/>
          <span>{data.twitter_username ? data.twiitter_username : "not available"}</span>
        </div>
        <div className={classes.sl}>
          <img src={company}/>
          <span className={classes.twit}>@{data.company ? data.company :'not available'}</span>
        </div>
      </div>
    </div>
  );
